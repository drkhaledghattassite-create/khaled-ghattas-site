            ...
            <div className="flex flex-col gap-2">
              ...
              {isUpcoming && event.registrationUrl && (
                <a
                  ...
                  className="font-label mt-2 inline-flex w-max items-center gap-2 rounded-full border border-dashed border-ink bg-ink px-4 py-2 text-[11px] text-cream-soft transition-colors duration-300 hover:bg-transparent hover:text-ink"

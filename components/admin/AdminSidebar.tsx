...
export function AdminSidebar({ user }: { user: MockUser }) {
  ...
  return (
    <aside className="sticky top-0 flex h-dvh w-[240px] shrink-0 flex-col border-e border-ink/10 bg-cream-soft">
      <div className="flex h-[64px] items-center gap-3 border-b border-ink/10 px-5">
        <span aria-hidden className="block h-8 w-8 rounded-full bg-ink" />
      ...
      <div className="border-t border-ink/10 p-3">
        <div className="flex items-center gap-2.5 rounded px-2 py-2">
          ...
          <button
            ...
            className="inline-flex h-7 w-7 items-center justify-center rounded text-ink-muted transition-colors hover:bg-cream-warm/80 hover:text-ink"
          >

  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <LogoLink href="/" alt={tNav('brand')} height={24} />
        <span
      ...
      {/* Quote block — center */}
      <div className="my-[clamp(20px,3vw,40px)]">
        <span
          aria-hidden
          className="block w-10 h-[3px] bg-[var(--color-accent)] mb-5"
        />
        <span
          className={`block mb-3 text-[11px] font-semibold uppercase tracking-[0.16em] text-[var(--color-accent)] ${
        ...
        <blockquote className="m-0">
          <p
            className={`m-0 max-w-[420px] text-[clamp(20px,2.2vw,28px)] leading-[1.35] font-medium tracking-[-0.005em] text-[var(--color-fg1)] [text-wrap:pretty] ${
          ...
          <footer
            className={`mt-4 inline-flex items-center gap-2.5 text-[12px] font-semibold uppercase tracking-[0.16em] text-[var(--color-fg3)] before:content-[''] before:w-6 before:h-px before:bg-[var(--color-border-strong)] before:inline-block ${
      ...
      {/* Subline */}
      <p
        className={`m-0 max-w-[380px] text-[13.5px] leading-[1.55] text-[var(--color-fg2)] ${
